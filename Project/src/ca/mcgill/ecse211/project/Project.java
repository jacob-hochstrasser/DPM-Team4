...
public class Project {
    ...
    private static final SensorModes LOCALIZING_LIGHT_SENSOR = new EV3ColorSensor(LocalEV3.get().getPort("S4"));
    private static final SensorModes IDENTIFYING_LIGHT_SENSOR = new EV3ColorSensor(LocalEV3.get().getPort("S2"));
